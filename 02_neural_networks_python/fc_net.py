...
class TwoLayerNet(object):
    ...
    def __init__(
        ...
        self.params['W2'] = np.random.normal(scale=weight_scale, size=(hidden_dim1, num_classes))
    ...
    def loss(self, X, y=None):
        ...
        dx2, grads['W1'], grads['b1'] = affine_relu_backward(dx_affine_backward, cache_layer1)
